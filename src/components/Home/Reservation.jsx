      ...
      <div className={`${Styles.reserve}`}>
        <div className={`${Styles.reserve_form}`}>
          <div
            ...
            data-aos="fade-up"
          >
            <h1 className="text-5xl lg:text-6xl text-[#C8A97E] font-bold">
              Book a table
            </h1>
          ...
          <form
            onSubmit={sendEmail}
            ref={formRef}
            className="mx-6 md:mx-0 flex flex-col gap-6 md:grid md:grid-cols-2 md:gap-8 md:px-6 lg:px-12"
          >
            <label htmlFor="name" className="flex flex-col gap-2">
              ...
              <input
                name="name"
                type="text"
                className="p-4 md:px-4 lg:py-5 md:m-0 border-solid border-2 border-[#E5E5E5]"
            ...
            <label htmlFor="person" className="flex flex-col gap-2">
              ...
              <select
                name="person"
                className="p-4 md:px-4 lg:py-5 md:m-0 border-solid border-2 border-[#E5E5E5] text-base font-bold"
              >
            ...
            <button
              type="submit"
              className="border-solid border-2 text-white border-[#C8A97E] bg-[#C8A97E] px-4 py-4 lg:py-6 text-xl md:text-base lg:text-xl font-bold hover:bg-white hover:text-black "
            >
              Make Reservation
            </button>
            <div className="mt-4">
