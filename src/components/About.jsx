...
function About() {
  return (
    <div className="my-24 flex flex-col gap-y-12 md:px-14  md:grid md:grid-cols-2 md:gap-x-8">
      <div className="flex mx-2 md:mx-0 items-center justify-center md:gap-6">
      ...
      <div className="mx-4">
        ...
        <p className="leading-9 md:leading-10 text-xl md:text-2xl text-[#7A7A7A]">
          A small river named Duden flows by the
        ...
        <h3 className="text-2xl md:text-4xl text-[#c8a97e] font-bold">+234-909-876-0067</h3>
      </div>
    </div>
  );
}
